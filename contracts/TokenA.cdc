...
pub contract TokenA: FungibleToken {
    ...
    //
    pub fun createEmptyVault(): @TokenA.Vault {
    ...
    pub resource Minter {
        ...
        //
        pub fun mintTokens(amount: UFix64): @TokenA.Vault {
            pre {
    ...
    pub resource Administrator {
        ...
        // transactions/tokenA/minter/setup_minter_account.cdc
        // then the admin account running:
        // transactions/tokenA/admin/deposit_minter_capability.cdc
        //
    ...
    init() {
        ...
        self.MinterProxyPublicPath = /public/tokenAMinterProxy
        self.MinterProxyStoragePath = /storage/tokenAMinterProxy
