...
/************************************************************************/
    pub resource Metadata {  // Metadata struct for NFT, will be transfered to the NFT.
        ...
        {            
            pre {
                DAAM_V11.validInteract(interact) : "This Interaction is not Authorized"
...
pub resource interface CollectionPublic {
    pub fun borrowDAAM(id: UInt64): &DAAM_V11.NFT? // Get NFT as DAAM_V11.NFT
...
// Standand Flow Collection Wallet
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic,
        ...
        pub fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                return MetadataViews.NFTCollectionData (
                    storagePath: DAAM_V11.collectionStoragePath,
                    publicPath: DAAM_V11.collectionPublicPath,
                    providerPath: DAAM_V11.collectionPrivatePath,
                    publicCollection: Type<@DAAM_V11.Collection>(),
                    publicLinkedType: Type<&DAAM_V11.Collection{DAAM_V11.CollectionPublic, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection, MetadataViews.Resolver}>(),
                    providerLinkedType: ?????, // TODO  ???
                    createEmptyCollectionFunction: (DAAM_V11.createEmptyCollection() : @DAAM_V11.Collection) // TODO ???
                )*/
                default: return nil
        ...
        pub fun borrowViewResolver(id: UInt64): &{MetadataViews.Resolver} {
            ...
            let token <- self.ownedNFTs.remove(key: id)! as! @DAAM_V11.NFT // Get NFT
            let ref = &token as! &DAAM_V11.NFT{MetadataViews.Resolver} // Get reference to NFT
            let oldToken <- self.ownedNFTs[id] <- token   // Store NFT
            destroy oldToken                              // destroy place holder
            return ref //as! &DAAM_V11.NFT{MetadataViews.Resolver}
        }
        ...
        // borrowDAAM gets a reference to an DAAM_V11.NFT in the album.
        pub fun borrowDAAM(id: UInt64): &DAAM_V11.NFT {
