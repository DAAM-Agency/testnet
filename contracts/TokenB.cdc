...
pub contract TokenB: FungibleToken {
    ...
    // Total supply of TokenB in existence
    ...
    //
    pub fun createEmptyVault(): @TokenB.Vault {
    ...
    pub resource Minter {
        ...
        //
        pub fun mintTokens(amount: UFix64): @TokenB.Vault {
            pre {
    ...
    pub resource Administrator {
        ...
        // transactions/tokenB/minter/setup_minter_account.cdc
        // then the admin account running:
        // transactions/tokenB/admin/deposit_minter_capability.cdc
        //
    ...
    init() {
        ...
        self.MinterProxyPublicPath = /public/tokenBMinterProxy
        self.MinterProxyStoragePath = /storage/tokenBMinterProxy
