...
pub fun main(creator: Address): {UInt64 : {UInt64: AuctionHouse_V17.SaleHistory}} { // {MID : {TokenID:SaleHistory} }
    let creatorMIDs = DAAM_V22.getCreatorMIDs(creator: creator)
    var history: {UInt64 : {UInt64:AuctionHouse_V17.SaleHistory} } = {}
    for mid in creatorMIDs! {
        let historyEntry = AuctionHouse_V17.getHistory(mid: mid)
