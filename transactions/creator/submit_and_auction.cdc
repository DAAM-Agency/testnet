...
pub fun setFile(ipfs: Bool, string_cid: String, type_path: String?): {MetadataViews.File} {
    ...
    switch type_path! {
        case "text": return DAAM_V20.OnChain(file: string_cid)
        case "jpg": return DAAM_V20.OnChain(file: string_cid)
        case "jpg": return DAAM_V20.OnChain(file: string_cid)
        case "png": return DAAM_V20.OnChain(file: string_cid)
        case "bmp": return DAAM_V20.OnChain(file: string_cid)
        case "gif": return DAAM_V20.OnChain(file: string_cid)
...
{    
    ...
    prepare(creator: AuthAccount) {
        ...
        self.metadataCap  = creator.getCapability<&DAAM_V20.MetadataGenerator{DAAM_V20.MetadataGeneratorMint}>(DAAM_V20.metadataPublicPath)!
