...
pub fun setFile(ipfs: Bool, string_cid: String, type_path: String?): {MetadataViews.File} {
    ...
    switch type_path! {
        case "text": return DAAM_V16.OnChain(file: string_cid)
        case "jpg": return DAAM_V16.OnChain(file: string_cid)
        case "jpg": return DAAM_V16.OnChain(file: string_cid)
        case "png": return DAAM_V16.OnChain(file: string_cid)
        case "bmp": return DAAM_V16.OnChain(file: string_cid)
        case "gif": return DAAM_V16.OnChain(file: string_cid)
...
{    
    ...
    prepare(creator: AuthAccount) {
        ...
        self.metadataCap  = creator.getCapability<&DAAM_V16.MetadataGenerator{DAAM_V16.MetadataGeneratorMint}>(DAAM_V16.metadataPublicPath)!
