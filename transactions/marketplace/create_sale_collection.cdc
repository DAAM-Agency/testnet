...
transaction(withdrawID: UInt64, price: UFix64) {
    ...
    prepare(acct: AuthAccount) {
        ...
        let receiver = acct.getCapability<&FungibleToken.Vault>(Marketplace.vaultPublicPath)
        ...
        let collectionRef = acct.borrow<&NonFungibleToken.Collection>(from: DAAM.collectionStoragePath)
