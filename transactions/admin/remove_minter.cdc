...
transaction(exMinter: Address) {
    ...
    pre { DAAM_V8.V8..isMinter(exMinter) == true : exMinter.toString().concat(" is not an Minter.") }
    ...
    post { DAAM_V8.V8..isMinter(self.exMinter) == nil : self.exMinter.toString().concat(" is still an Minter.") }
