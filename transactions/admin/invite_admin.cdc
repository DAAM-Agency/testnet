...
transaction(newAdmin: Address)
{
    ...
    pre {
        DAAM_V12.isAdmin(newAdmin) == nil   : newAdmin.toString().concat(" is already an Admin.")
        DAAM_V12.isAgent(newAdmin) == nil   : newAdmin.toString().concat(" is already an Agent.")
        DAAM_V12.isCreator(newAdmin) == nil : newAdmin.toString().concat(" is already an Creator.")
    }
