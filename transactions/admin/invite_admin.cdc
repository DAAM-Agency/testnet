...
transaction(newAdmin: Address)
{
    ...
    pre {
        DAAM_V8.V8..isAdmin(newAdmin) == nil   : newAdmin.toString().concat(" is already an Admin.")
        DAAM_V8.V8..isAgent(newAdmin) == nil   : newAdmin.toString().concat(" is already an Agent.")
        DAAM_V8.V8..isCreator(newAdmin) == nil : newAdmin.toString().concat(" is already an Creator.")
    }
