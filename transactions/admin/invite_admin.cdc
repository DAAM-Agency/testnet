...
transaction(newAdmin: Address)
{
    ...
    pre {
        DAAM_V20.isAdmin(newAdmin) == nil   : newAdmin.toString().concat(" is already an Admin.")
        DAAM_V20.isAgent(newAdmin) == nil   : newAdmin.toString().concat(" is already an Agent.")
        DAAM_V20.isCreator(newAdmin) == nil : newAdmin.toString().concat(" is already an Creator.")
    }
