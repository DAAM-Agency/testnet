...
transaction(newAgent: Address, minterAccess: Bool)
{
    ...
    pre {
        ...
        DAAM_V19.isCreator(newAgent) == nil : newAgent.toString().concat(" is already a Creator.")
        DAAM_V19.isMinter(newAgent)  == nil : newAgent.toString().concat(" is already a Minter.")
    }
