...
transaction(newAgent: Address, minterAccess: Bool)
{
    ...
    pre {
        ...
        DAAM_V18.isCreator(newAgent) == nil : newAgent.toString().concat(" is already a Creator.")
        DAAM_V18.isMinter(newAgent)  == nil : newAgent.toString().concat(" is already a Minter.")
    }
