...
transaction(newAgent: Address, minterAccess: Bool)
{
    ...
    pre {
        ...
        DAAM_V21.V21.isCreator(newAgent) == nil : newAgent.toString().concat(" is already a Creator.")
        DAAM_V21.V21.isMinter(newAgent)  == nil : newAgent.toString().concat(" is already a Minter.")
    }
