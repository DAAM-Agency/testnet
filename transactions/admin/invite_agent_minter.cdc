...
>>>>>>> 586a0096 (updated FUSD Address)
    ...
    pre {
        ...
        DAAM_V22.V22.isCreator(newAgent) == nil : newAgent.toString().concat(" is already a Creator.")
        DAAM_V22.V22.isMinter(newAgent)  == nil : newAgent.toString().concat(" is already a Minter.")
    }
