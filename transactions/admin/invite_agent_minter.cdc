...
transaction(newAgent: Address, minterAccess: Bool)
{
    ...
    pre {
        ...
        DAAM_V15.isCreator(newAgent) == nil : newAgent.toString().concat(" is already a Creator.")
        DAAM_V15.isMinter(newAgent)  == nil : newAgent.toString().concat(" is already a Minter.")
    }
