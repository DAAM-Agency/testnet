...
transaction(newAgent: Address, minterAccess: Bool)
{
    ...
    pre {
        ...
        DAAM_V17.isCreator(newAgent) == nil : newAgent.toString().concat(" is already a Creator.")
        DAAM_V17.isMinter(newAgent)  == nil : newAgent.toString().concat(" is already a Minter.")
    }
