...
transaction(newAgent: Address, minterAccess: Bool)
{
    ...
    pre {
        ...
        DAAM_V12.isCreator(newAgent) == nil : newAgent.toString().concat(" is already a Creator.")
        DAAM_V12.isMinter(newAgent)  == nil : newAgent.toString().concat(" is already a Minter.")
    }
