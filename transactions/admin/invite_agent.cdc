...
transaction(newAgent: Address)
{
    ...
    pre {
        ...
        DAAM_V23.isCreator(newAgent) == nil : newAgent.toString().concat(" is already an Creator.")
    }
    ...
    post { DAAM_V23.isAgent(self.newAgent) != nil : self.newAgent.toString().concat(" invitation has not been sent.") }
}
