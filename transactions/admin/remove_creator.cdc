...
transaction(creator: Address)
{
    ...
    // Verify is Creator
    pre { DAAM_V8.V8..isCreator(creator) != nil : creator.toString().concat(" is not a Creator. Can not remove.") }
    ...
    post { DAAM_V8.V8..isCreator(self.creator) == nil : self.creator.toString().concat(" has Not been removed.") } // Verify is not a Creator
}
