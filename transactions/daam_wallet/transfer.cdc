...
transaction(signer: Address, withdrawID: UInt64) {
    ...
    prepare(acct: AuthAccount) {
        ...
        let collectionRef = acct.borrow<&DAAM_V15.Collection{NonFungibleToken.Provider}>(from: DAAM_V15.collectionStoragePath)
    ...
    execute {        
        ...
        let receiverCap = recipient.getCapability<&DAAM_V15.Collection{NonFungibleToken.Receiver}>(DAAM_V15.collectionPublicPath)
        let receiverRef = receiverCap.borrow()! //as &DAAM_V15.Collection //{NonFungibleToken.CollectionPublic}
