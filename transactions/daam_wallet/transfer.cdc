...
transaction(signer: Address, withdrawID: UInt64) {
    ...
    prepare(acct: AuthAccount) {
        ...
        let collectionRef = acct.borrow<&DAAM_V13.Collection{NonFungibleToken.Provider}>(from: DAAM_V13.collectionStoragePath)
    ...
    execute {        
        ...
        let receiverCap = recipient.getCapability<&DAAM_V13.Collection{NonFungibleToken.Receiver}>(DAAM_V13.collectionPublicPath)
        let receiverRef = receiverCap.borrow()! //as &DAAM_V13.Collection //{NonFungibleToken.CollectionPublic}
