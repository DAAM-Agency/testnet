...
transaction(signer: Address, withdrawID: UInt64) {
    ...
    prepare(acct: AuthAccount) {
        ...
        let collectionRef = acct.borrow<&DAAM_V17.Collection{NonFungibleToken.Provider}>(from: DAAM_V17.collectionStoragePath)
    ...
    execute {        
        ...
        let receiverCap = recipient.getCapability<&DAAM_V17.Collection{NonFungibleToken.Receiver}>(DAAM_V17.collectionPublicPath)
        let receiverRef = receiverCap.borrow()! //as &DAAM_V17.Collection //{NonFungibleToken.CollectionPublic}
