...
transaction(signer: Address, withdrawID: UInt64) {
    ...
    prepare(acct: AuthAccount) {
        ...
        let collectionRef = acct.borrow<&DAAM_V12.Collection{NonFungibleToken.Provider}>(from: DAAM_V12.collectionStoragePath)
    ...
    execute {        
        ...
        let receiverCap = recipient.getCapability<&DAAM_V12.Collection{NonFungibleToken.Receiver}>(DAAM_V12.collectionPublicPath)
        let receiverRef = receiverCap.borrow()! //as &DAAM_V12.Collection //{NonFungibleToken.CollectionPublic}
