...
transaction(signer: Address, withdrawID: UInt64) {
    ...
    prepare(acct: AuthAccount) {
        ...
        let collectionRef = acct.borrow<&DAAM_V16.Collection{NonFungibleToken.Provider}>(from: DAAM_V16.collectionStoragePath)
    ...
    execute {        
        ...
        let receiverCap = recipient.getCapability<&DAAM_V16.Collection{NonFungibleToken.Receiver}>(DAAM_V16.collectionPublicPath)
        let receiverRef = receiverCap.borrow()! //as &DAAM_V16.Collection //{NonFungibleToken.CollectionPublic}
