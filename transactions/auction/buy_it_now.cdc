...
transaction(auction: Address, tokenID: UInt64, bid: UFix64)
{
    ...
    let collection      : &{DAAM_V1.CollectionPublic}
    ...
    prepare(bidder: AuthAccount) {
        ...
        self.collection = getAccount(bidder.address).getCapability<&{DAAM_V1.CollectionPublic}>(DAAM_V1.collectionPublicPath).borrow()!
    }
