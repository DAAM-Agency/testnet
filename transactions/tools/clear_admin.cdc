...
transaction() {
    prepare(admin: AuthAccount) {
        ...
        let adminRes6 <- admin.load<@DAAM_V6.Admin>(from: DAAM_V6.adminStoragePath)
        let requestRes6 <- admin.load<@DAAM_V6.RequestGenerator>(from: DAAM_V6.requestStoragePath)
        destroy adminRes6
        destroy requestRes6
