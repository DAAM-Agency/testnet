...
flow transactions send ./transactions/creator/submit_accept.cdc "Name D" nil '["Digital","Image"]' nil "description D" false  "thumbnail D" "file" false  "file D" "file" 0.14 --signer creator # Will be MID 4
