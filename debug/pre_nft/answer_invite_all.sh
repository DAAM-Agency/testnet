...
flow transactions send ./transactions/answer/answer_agent_invite.cdc true --signer agent
flow transactions send ./transactions/answer/answer_agent_invite.cdc true --signer agent2
...
flow transactions send ./transactions/answer/answer_creator_invite.cdc true --signer creator
flow transactions send ./transactions/answer/answer_creator_invite.cdc true --signer creator2
