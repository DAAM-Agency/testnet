...
flow transactions send ../testnet_keys/init_DAAM_V21_Agency.cdc --arg String:"DAAM_V21" --arg String:$HEX_ENCODE_CODE --arg Address:$AGENCY --arg Address:$CTO --signer daam_nft
