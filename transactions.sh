...
flow transactions send ./testnet/transactions/creator/mint_nft.cdc --arg Address:$CREATOR --arg Int:2 --signer admin2
sleep 1s
flow transactions send ./testnet/transactions/creator/mint_nft.cdc --arg Address:$CREATOR --arg Int:1 --signer admin
flow transactions send ./testnet/transactions/creator/mint_nft.cdc --arg Address:$CREATOR --arg Int:0 --signer admin2
